# In FAST_API/app/api/admin_api.py
...
def create_database_endpoint():
    # ... (Paste the full create_database_endpoint function code from my previous answer here) ...
    ...
    for person_name in os.listdir(config.DATABASE_DIR):
        ...
        if os.path.isdir(person_dir):
            ...
            if embeddings:
                ...
                if not torch.isnan(mean_embedding).any():
                    new_face_db[person_name] = mean_embedding
    if new_face_db:
