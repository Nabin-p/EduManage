            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    ...
                    <p class="text-primary">
                        <small><i class="bi bi-exclamation-diamond-fill me-2"></i> Create related "Class" and "Section" before adding student</small>
                    </p>
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.student.create')}}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                {{-- <div class="col-md-4">
                                    ...
                                    <select id="inputReligion" class="form-select" name="religion" required>
                                        ...
                                        <option {{old('religion') == 'Hinduism' ? 'selected' : ''}}>Islam</option>
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputFatherName" name="father_name" placeholder="" required value="{{old('father_name')}}">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputMotherName" name="mother_name" placeholder="" required value="{{old('mother_name')}}">
                                </div>
                                <div class="col-md-3">
