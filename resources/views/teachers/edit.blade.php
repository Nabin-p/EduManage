                    ...
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.teacher.update')}}" method="POST">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" name="first_name" placeholder="" required value="{{$teacher->first_name}}">
                            </div>
                            <div class="col-3">
                                <label for="inputLastName" class="form-label">Last Name<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                <input type="text" class="form-control" id="inputLastName" name="last_name" placeholder="" required value="{{$teacher->last_name}}">
                            </div>
                            <div class="col-3">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control" id="inputAddress" name="address" placeholder="" required value="{{$teacher->address}}">
                            </div>
                            <div class="col-3">
                            ...
                            <div class="col-2">
                                ...
                                <input type="text" class="form-control" id="inputCity" name="city" placeholder="" required value="{{$teacher->city}}">
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="inputPhone" name="phone" placeholder="" required value="{{$teacher->phone}}">
                            </div>
                            <div class="col-2">
